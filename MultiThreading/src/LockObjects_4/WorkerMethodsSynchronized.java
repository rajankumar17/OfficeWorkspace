...
/**
Here total time is more because the lock is taken on worker object for the synchronized methods
 so even the second method is totally independent ,still it has to wait for the lock to free before running it.
 */
